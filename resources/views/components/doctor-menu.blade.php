...
<a href="{{ route('analyze-medical-report') }}" class="bg-blue-800 opacity-90 rounded-full m-2 px-4 py-2 text-gray-200 hover:text-gray-700 hover:bg-white flex items-center {{ request()->is('doctor/analyze-medical-report') ? 'active' : '' }}">
    <i class="fas fa-file-medical-alt mr-2"></i> Analyze Medical Report
</a>
<div class="px-4">
    <a href="{{ route('analyzed-reports') }}" class="bg-blue-800 opacity-90 rounded-full m-2 py-2 text-gray-200 hover:text-gray-700 hover:bg-white flex items-center {{ request()->is('doctor/analyzed-reports') ? 'active' : '' }}">
