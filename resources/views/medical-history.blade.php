                            ...
                            <td class="p-2">                               
                                @switch($appointment['status'])
                                    @case('expired')
                                        ...
                                        @break
                                    @case('scheduled')
                                        <span class="bg-yellow-100 text-sm p-1 px-3 rounded-full text-yellow-800">scheduled</span>
                                        @break
                                    @default
                                        <span class="bg-green-100 text-sm p-1 px-3 rounded-full text-green-800">successfull</span>
                                @endswitch
                            </td>
